...
class TestInsulinPump(unittest.TestCase):
    def test_corrective_bolus_delivery(self):
        ...
        current_glucose = 180  # Glycémie mesurée en mg/dL
        target_glucose = 120  # Glycémie cible en mg/dL
        insulin_sensitivity_factor = 30  # ISF en mg/dL par unité
        ...
        self.assertEqual(correction_bolus, 2)  # Vérifie que le bolus de correction est bien de 2 U
